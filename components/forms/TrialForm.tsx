...
export default function TrialForm() {
  ...
  const handleSubmit = (e: any) => {
    fetch("/", {
      ...
      body: encode({ "form-name": "contact", terms, gdpr, expectedUsers })
    })
      .then(() => alert("Success!"))
  ...
  return (
    <Segment color="blue" style={{ textAlign: "left", paddingLeft: "30px", paddingRight: "30px", paddingTop: "30px" }}>
      ...
      <Divider hidden />
      <form onSubmit={handleSubmit} className="ui form" name="enterprise-trial" method="POST" aria-disabled={true} data-netlify="true">
        ...
        <Divider hidden />
        <select className="ui selection dropdown" name="flooring-type[]" required={true}>
          <option className="item" value="" disabled={true} selected={true}>Choose Flooring type</option>
